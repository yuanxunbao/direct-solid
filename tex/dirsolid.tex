...
\end{figure}
 ...
 \begin{figure}[!ht]
 \centering
     \subfloat[$U_0=-0.78$\label{subfig-1:phi}]{%
       \includegraphics[width=0.7\textwidth]{./figures/U_p78.png}
     }
     \hfill
     \subfloat[$U_0=-0.72$\label{subfig-2:c/cinf}]{%
       \includegraphics[width=0.7\textwidth]{./figures/U_p72.png}
     }     
