...
# arrays on device
psi_cp = cp.asarray(psi, dtype=cp.float32)
phi_cp = cp.asarray(phi, dtype=cp.float32)
U_cp   = cp.asarray(U  , dtype=cp.float32)
zz_cp  = cp.asarray(zz , dtype=cp.float32)
dPSI_cp = cp.zeros(psi_cp.shape, dtype = cp.float32)
dU_cp = cp.zeros(psi_cp.shape, dtype = cp.float32)

# buffer on GPU to move frame
psi_buff = cp.empty(psi_cp.shape, dtype = cp.float32)
phi_buff = cp.empty(phi_cp.shape, dtype = cp.float32)
U_buff = cp.empty(U_cp.shape, dtype = cp.float32)
zz_buff = cp.empty(zz_cp.shape, dtype = cp.float32) 
