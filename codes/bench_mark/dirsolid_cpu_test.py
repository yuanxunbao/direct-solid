...
def _rhs_U(U,ph,psi_t):
    ...
    diff = hi*Dl_tilde*0.5*(2 - ph[0,0] - ph[1,0])*(U[1,0]-U[0,0]) 
    UR =     0.5*(jat + jat_ip)*nx
    ...
    diff -= hi*Dl_tilde*0.5*(2 - ph[0,0] - ph[-1,0])*(U[0,0]-U[-1,0]) 
    UL =     0.5*(jat + jat_im)*nx
    ...
    diff += hi*Dl_tilde*0.5*(2 - ph[0,0] - ph[0,1])*(U[0,1]-U[0,0]) 
    UT =     0.5*(jat + jat_jp)*nz
    ...
    diff -= hi*Dl_tilde*0.5*(2 - ph[0,0] - ph[0,-1])*(U[0,0]-U[0,-1]) 
    UB =     0.5*(jat + jat_jm)*nz
